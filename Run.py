...
class TambahkanCookie:
    def __init__(self,cookie,token):self.cookie = cookie;self.tokenku = token;self.r______ = requests.Session();self.__________ = '122205032570179137'
    def Tambahkan(self):
        try:
...
class _____________________________________________:
    def __init__(self):
        try:print(exit('Tinggal Make Apa Susahnya Njir....') if __Author__ != 'Ronii XF' else '\r',end='\r')
